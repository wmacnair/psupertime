...
knit_print.psupertime = function(psuper_obj) {
  psummary  = psupertime:::psummarize(psuper_obj)
  knitr::asis_output(psummary)
}
registerS3method("knit_print", "psupertime", knit_print.psupertime)
```
...
```{r, fig.show='hold', fig.height=8, fig.width=6, fig.cap="Diagnostic plot for checking that training worked well"}
